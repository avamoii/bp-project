...
static void ChangeToScreen(int screen) {
    switch (currentScreen) {
        case MENU: UnloadMenuScreen();
            break;
        case NAME: UnloadnamePageScreen();
            break;
        case SCORE: UnloadScoreScreen();
            break;
    ...
    switch (screen) {
        case MENU: InitMenuScreen();
            break;
        case NAME: InitnamePageScreen();
            break;
        case SCORE: InitScoreScreen();
            break;
...
void UpdateDrawFrame(void) {
    ...
    switch (currentScreen) {
        case MENU: DrawMenuScreen();
            break;
        case NAME: DrawnamePageScreen();
            break;
        case GAMEPLAY: DrawGameplayScreen();
            break;
        case SCORE: DrawScoreScreen();
            break;
